              ...
              <span className="mr-2 font-bold text-gray-600">
                ...
                >
                  ...
                  <rect
                    ...
                    stroke-width="0.5"
                  />
                  <g clip-path="url(#clip0_2659_144)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
              ...
              <div className="mt-3">
                {chat.type == "user" ? (
                  ...
                  <div className="flex items-center gap-1 mb-5">
                    ...
                    >
                      <path
                        d="M18.9939 8.69309L17.5381 7.42886C16.4893 6.51796 16.0781 6.02795 15.5101 6.20118C14.8018 6.41718 15.035 7.7801 15.035 8.24022C13.9338 8.24022 12.789 8.15553 11.7036 8.33199C8.12044 8.91454 7 11.4639 7 14.2104C8.01414 13.5888 9.02728 12.8955 10.2462 12.6074C11.7677 12.2478 13.4669 12.4194 15.035 12.4194C15.035 12.8795 14.8018 14.2424 15.5101 14.4584C16.1537 14.6547 16.4893 14.1416 17.5381 13.2308L18.9939 11.9665C19.8868 11.1911 20.3333 10.8034 20.3333 10.3298C20.3333 9.85627 19.8868 9.46855 18.9939 8.69309Z"
                        stroke="#141B34"
                        stroke-opacity="0.6"
                        stroke-linecap="round"
                      ...
                      />
                      <path
                        d="M10.8067 4.5C7.58978 4.50578 5.90528 4.5846 4.82875 5.65894C3.66699 6.81835 3.66699 8.68437 3.66699 12.4164C3.66699 16.1485 3.66699 18.0145 4.82874 19.1739C5.9905 20.3333 7.86031 20.3333 11.5999 20.3333C15.3396 20.3333 17.2094 20.3333 18.3712 19.1739C19.18 18.3667 19.4257 17.2169 19.5003 15.3333"
                        stroke="#141B34"
                        stroke-opacity="0.6"
                        stroke-linecap="round"
                        stroke-linejoin="round"
